//! Quarantined **Drez-era** loaders (`.dat` tables, unused serde helpers).
//! Not part of the default asset pipeline — kept for migration reference only.
//! Public vehicle JSON path: [`super::deserializers::deserialize_road_vehicle_configs`].
#![allow(dead_code)]
