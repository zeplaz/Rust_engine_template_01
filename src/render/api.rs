...
pub use super::pipelines::infrastructure_overlay::{
...
pub use super::pipelines::terrain_instanced_draw::{
...
pub use super::pipelines::terrain_gpu_bake_spike::{
    build_bake_spike_probe, build_terrain_gpu_bake_spike_witness_body,
    collect_material_bake_instances, pack_gpu_bake_scissors, peek_dirty_chunk_coords,
    refresh_terrain_gpu_bake_spike_witness, sample_atlas_material_rgba,
    spike_bake_ready_for_consumers, terrain_gpu_bake_spike_a0_green,
    terrain_gpu_bake_spike_a1_green, terrain_gpu_bake_spike_env_enabled,
    write_atlas_to_world_bake, TerrainGpuBakeIndexMap, TerrainGpuBakeScissor,
    TerrainGpuBakeSpikePlugin, TerrainGpuBakeSpikeProbe, TerrainGpuBakeSpikeState,
    TERRAIN_GPU_BAKE_SPIKE_A1_LIVE_JSON, TERRAIN_GPU_BAKE_SPIKE_ENV,
...
pub use super::pipelines::tactical_vector_overlay::{
...
pub use super::fx_spine::fire_chunk_entity_index::{
...
pub use super::core::gpu_bind_group_registry::{
...
pub use super::core::gpu_representation_metrics::GpuRepresentationMetrics;
pub use super::pipelines::gpu_particle_draw::{
...
pub use super::pipelines::gpu_spark_compute::{
    build_fire_spark_attractors, register_fire_spark_compute,
    FireSparkAttractors, SparkSimState, WorldFireSparkComputeDispatch,
};
pub use super::pipelines::gpu_fire_particle_raster::{register_fire_particle_raster_draw, FireDrawDiagnostics, FireParticleDrawGlobals};
pub use super::pipelines::gpu_water_surface_draw::{register_water_surface_draw, WaterOverlayDrawGlobals};
pub use super::pipelines::gpu_water_particle_draw::{
    register_world_water_particle_draw, WorldWaterParticleDrawDispatch, WorldWaterParticleGpuStorage,
    WATER_PARTICLE_WGSL,
};
pub use super::pipelines::gpu_water_particle_raster::{register_world_water_particle_raster, WaterParticleDrawGlobals};
pub use super::pipelines::gpu_water_particles::{
...
pub use super::fx_spine::water_surface_visual::{
...
pub use super::pipelines::domain_overlay_gpu::{
    emit_domain_overlay_frame_from_projection, DomainOverlayGpuFrame, EcologyOverlayGpuRow,
    LogisticsOverlayGpuRow,
};
pub use super::extraction::extracted_camera_metrics::{
    particle_view_globals_from_metrics, sync_extracted_camera_metrics,
    ExtractedCameraMetrics, ExtractedCameraMetricsPlugin,
    ExtractedCameraMetricsSet, FireParticleCameraScale,
};
pub use super::fire_vfx::{
    effect_spawn_hook_resolver_wired, fire_spark_011_green, fire_spark_compute_enabled,
    resolve_effect_spawn, spawn_effect_consumable, EffectConsumable, EffectConsumableDef,
    EffectConsumableRegistry, EffectConsumableRegistryPlugin, EffectFieldId, EffectLane,
    EffectResolvedSpawn, EffectSpawnResolveContext, FireSparkWitness, SpawnHookKind,
    EFFECT_REGISTRY_ROOT, FIRE_SPARK_FULL_SCATTER_PX_PER_TILE, FIRE_SPARK_MIN_PX_PER_TILE,
    FIRE_SPARK_OPERATIONAL_PLAY_PX_PER_TILE, FIRE_SPARK_SCATTER_MAX,
    FIRE_SPARK_TACTICAL_PROOF_ZOOM_ALPHA,
};
pub use super::particle_domains::{
    ParticleDomainEntry, ParticleDomainId, ParticleDomainRegistry, ParticleDomainRegistryPlugin,
};
pub use super::weather_vfx::{
    apply_weather_precip_frame_from_climate, apply_weather_precip_frame_from_climate_at,
    build_precip_streak_instances, build_precip_streak_instances_at,
    ...
    weather_vfx_witness_json_with_status, WeatherPrecipDrawStatus, WeatherPrecipFrame,
    WeatherPrecipZoomBand, WeatherVfxPlugin, WEATHER_PRECIP_STREAK_CAP,
};
pub use super::pipelines::gpu_instanced_quad::{
    GpuInstancedQuadInstance, GpuInstancedQuadVertex, ParticleSystemUniforms, ParticleViewGlobals,
};
pub use super::pipelines::gpu_particles::{
...
pub use super::core::gpu_packed_formats::{
...
pub use super::core::gpu_buffer_registry::{
...
pub use super::witness::vt_spatial_invariants::{
...
pub use super::extraction::logistics_visual_snapshot::LogisticsVisualSnapshot;
pub use super::extraction::ecology_visual_snapshot::EcologyVisualSnapshot;
pub use super::extraction::visual_domain_snapshots::{
...
pub use super::witness::phase_f_lod_proof::{PhaseFLodProofPlugin, PhaseFLodProofReport};
pub use super::core::gpu_surface_teardown::{GpuSurfaceTeardownPlugin, VisualTestGracefulExit};
pub use super::core::per_view_residency::{
...
pub use super::fx_spine::view_fire_projection::{
...
pub use super::probes::debug_render_trace::{
...
pub use super::probes::visual_diagnostics::{
    visual_diag_enabled, visual_diag_plugin_latch, VisualDiagnosticsPlugin, VISUAL_DIAG_TARGET,
};
pub use super::probes::debug_viewport_overlay::{debug_viewport_overlay_enabled, DebugViewportOverlayPlugin};
...
pub use super::probes::full_render_diagnostic::{
...
pub use super::extraction::fire_view_extract::{
...
pub use super::core::gpu_surface_teardown::visual_teardown_vr02_wired;
pub use super::probes::vfx_capture_hook::{VfxCaptureHookPlugin, VfxCaptureHookState};
pub use super::extraction::sim_visual_extract::{
...
pub use super::pipelines::overlay_field_buffers::{
...
pub use super::witness::visual_agreement::{
...
pub use super::witness::vt_ci_matrix::{
...
pub use super::extraction::domain_projection_frame::{
...
pub use super::probes::frame_perf::{
...
pub use super::probes::stall_watch::{
...
pub use super::pipelines::core2d_overlay_order::{
    core2d_overlay_pipeline_hdr_index, Core2dOverlayOrderPlugin, CORE2D_OVERLAY_SDR_FORMAT,
};
pub use super::pipelines::gpu_tile_debug_buffer::register_tile_debug_instance_storage_upload;
pub use super::pipelines::gpu_tile_debug_draw::register_tile_debug_instanced_draw;
pub use super::pipelines::gpu_indirect_draw::{
