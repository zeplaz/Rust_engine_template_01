...
| A6 | **UI-WP-VISUAL-001** | World preview `--test visual` sign-off (lib → visual) | [`ui_world_preview_coder_queue_v1.md`](../prompts/guides/ui/ui_world_preview_coder_queue_v1.md) | `wave_p_live.json` from visual run + layout greens |
...
Read: src/dev/fire_sim_phase7_architecture_v1.md § F7-A exit (A1–A5)
