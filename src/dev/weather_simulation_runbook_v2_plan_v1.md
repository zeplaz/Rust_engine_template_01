...
| **Date** | 2026-05-26 |
| **Owner** | `@planner` |
| **Status** | **SIGNED** — checkpoint satisfied (`wss_atmos_clipmap_001.green`) |
...
| Path | Keys |
|:---|:---|
| `debug_runs/wss_substrate_live.json` | `regional_weather_wired`, `climate_seed_present` |
| `debug_runs/stage5_full_app_live.json` | `weather_precip_gpu_authority` (when VFX migrated) |
