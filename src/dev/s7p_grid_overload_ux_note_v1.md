...
| **Owner** | `@designer` |
| **Status** | **SIGNED** |
| **Read** | [`power_damage_ui_persistence_v1.md`](../prompts/designer_questions/production_economy/power_damage_ui_persistence_v1.md) · [`industrial_grid_overload_impl_plan_v1.md`](industrial_grid_overload_impl_plan_v1.md) |
