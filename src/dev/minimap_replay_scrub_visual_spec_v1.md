...
| **Owner** | `@designer` |
| **Status** | **SIGNED** |
| **Parent** | [`minimap_m3_operational_overlay_spec_v1.md`](../prompts/guides/ui/minimap_m3_operational_overlay_spec_v1.md) § M3-04 |
...
Read: src/dev/minimap_replay_scrub_visual_spec_v1.md
