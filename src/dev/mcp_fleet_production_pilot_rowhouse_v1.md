...
> **MCP-PROD-PILOT-ROWHOUSE-001** from `src/dev/mcp_fleet_production_pilot_rowhouse_v1.md`.
>
...
> **MCP-PROD-KIT-001** then **MCP-PROD-TILE-001** from `src/dev/mcp_fleet_production_pilot_rowhouse_v1.md`.
>
