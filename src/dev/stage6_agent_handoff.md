...
Read: src/dev/stage6_active_todos.md (S6-1 rows), src/render/stage6_virtualization.rs,
...
Read: src/io/streaming/residency.rs, src/render/stage6_virtualization.rs,
  src/dev/view_runtime_architecture_v1.md, AGENTS.md Stage 6 rules
...
Read: debug_runs/stage6_virtualization_live.json, stage5_full_app_live.json,
  src/dev/stage6_active_todos.md S6-3, src/render/stage6_live_proof.rs
...
4. Write src/dev/stage6_operational_signoff.md; update stage6_plan_open.md §11.
...
Read: prompts/guides/experience_layer_ux_hud_designer_brief_v1.md §8,
  prompts/guides/rulebook_backlog_designer_brief_v1.md §4,
...
Read: src/dev/stage6_plan_open.md §6, stage6_active_todos.md DQ table,
  prompts/guides/backlog_serialization_preview_streaming_runbook_v1.md
