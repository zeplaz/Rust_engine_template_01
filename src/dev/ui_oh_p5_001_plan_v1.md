...
| **Pause plan (authoritative)** | [`ui_phase5_pause_menu_plan_v1.md`](../prompts/guides/ui/ui_phase5_pause_menu_plan_v1.md) |
...
Read: prompts/guides/ui/ui_phase5_pause_menu_plan_v1.md
      src/dev/ui_oh_p5_001_plan_v1.md
...
See [`ui_phase5_pause_menu_plan_v1.md`](../prompts/guides/ui/ui_phase5_pause_menu_plan_v1.md) § P5-DESIGN-001 — mock only; does not block **UI-OH-P5-001** qualified PASS.
