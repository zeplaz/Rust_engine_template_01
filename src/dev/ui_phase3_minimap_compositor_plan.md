...
| **Active queue** | [`ui_phase3_coder_queue_v1.md`](../prompts/guides/ui/ui_phase3_coder_queue_v1.md) §3.4 M2 |

**Entry:** P3 [`ui_phase0_panel_mocks_v1.md`](../prompts/guides/ui/ui_phase0_panel_mocks_v1.md) · spine [`map_view_spine.json`](../tools/orchestrator/knowledge/map_view_spine.json) · design [`ux_gpu_minimap_design_v1.md`](ux_gpu_minimap_design_v1.md)
...
**Next slice (post-M1):** [`ui_phase3_coder_queue_v1.md`](../prompts/guides/ui/ui_phase3_coder_queue_v1.md) **UI-P3-M2-001** — logistics heat (`logistics_rows > 0`).
