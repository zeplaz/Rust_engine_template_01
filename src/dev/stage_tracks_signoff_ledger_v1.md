...
| **Plan v1** (M1 spine) | planner | **APPROVED** v2 | [`ui_phase3_minimap_compositor_plan_v1.md`](../prompts/guides/ui/ui_phase3_minimap_compositor_plan_v1.md) |
| **PLAN-UI-P3-COMPOSITOR-001** | planner | **DONE** | [`ui_phase3_minimap_compositor_full_plan_v1.md`](../prompts/guides/ui/ui_phase3_minimap_compositor_full_plan_v1.md) — M1+M2+M3 rollup |

| **UI-P3-M2-PLAN** | planner | **DONE** | overlay plan + D-MINIMAP-M2 |
| **PLAN-UI-P3-M2-IMPL-001** | planner | **DONE** | [`ui_phase3_minimap_m2_impl_full_plan_v1.md`](../prompts/guides/ui/ui_phase3_minimap_m2_impl_full_plan_v1.md) — unblocks **UI-P3-M2-CODER-A** |
...
| **PLAN-WP-DECISION-001** | planner | **DONE** | [`world_preview_product_full_plan_v1.md`](../prompts/guides/ui/world_preview_product_full_plan_v1.md) — unblocks **DESIGN-D-WP-REVIEW** |

| **UI-WP-DESIGN** | designer | **SIGNED** | layout + D-04 spec |

| **UI-P4-PLAN** | planner | **DONE** | handoff plan |
| **PLAN-UI-P4-ATLAS-001** | planner | **DONE** | [`ui_phase4_icon_atlas_plan_v1.md`](../prompts/guides/ui/ui_phase4_icon_atlas_plan_v1.md) — icons + petroleum tab |
...
| **UI4-DESIGN-001** | designer | **SIGNED** | [`world_preview_d04_slide_sheet_spec_v1.md`](../prompts/guides/ui/world_preview_d04_slide_sheet_spec_v1.md) |
...
| Slice / gate | Agent | Status | Evidence |
|:---|:---|:---|:---|
| **PLAN-UI-P5-PAUSE-001** | planner | **DONE** | [`ui_phase5_pause_menu_plan_v1.md`](../prompts/guides/ui/ui_phase5_pause_menu_plan_v1.md) |
...
| **PLAN-WP-DECISION-001** | [`world_preview_product_full_plan_v1.md`](../prompts/guides/ui/world_preview_product_full_plan_v1.md) | **DONE** |
...
| **PLAN-UI-SHELL-2B-001** | [`ui_phase2b_gate_plan_v1.md`](../prompts/guides/ui/ui_phase2b_gate_plan_v1.md) · [`ui_p2b_coder_b_numbered_tasks_v1.md`](ui_p2b_coder_b_numbered_tasks_v1.md) | **DONE** |
...
| **PLAN-UI-P5-PAUSE-001** | [`ui_phase5_pause_menu_plan_v1.md`](../prompts/guides/ui/ui_phase5_pause_menu_plan_v1.md) | **DONE** |
