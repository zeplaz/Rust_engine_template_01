...
| Queue ID | `plan_doc` |
|:---|:---|
| **PLAN-ELEMENTAL-WAVE2-INDEX-001** | `src/dev/plan_elemental_wave2_index_001_v1.md` |
| **PLAN-WSS-HYBRID-RETIRE-PR4-001** | `src/dev/plan_wss_hybrid_retire_pr4_001_v1.md` |
| **PLAN-BQ128-APPLY-EXEC-001** | `src/dev/plan_bq128_apply_exec_001_v1.md` |
| **PLAN-LEDGER-REFRESH-008** | `src/dev/plan_ledger_refresh_008_checklist_v1.md` |
