...
Read: src/dev/stages/fire_sim_phase7_plan_v1.md · fire_sim_phase7_architecture_v1.md (when landed)
...
Read: src/dev/vfx_coder_phase2_queue_v1.md § P2-FIRE-SPARK-010
...
Read: src/dev/ux_e03_transmission_shell_note_v1.md
...
Read: src/dev/logistics_visual_lane_spec_v1.md
...
Read: src/dev/ind_board_reconcile_plan_v1.md
