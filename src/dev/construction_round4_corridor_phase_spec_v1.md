...
| **Runbook** | [`infrastructure_construction_runbook_v1.md`](../prompts/guides/infrastructure_construction_runbook_v1.md) §10 |
...
Read: src/dev/construction_round4_corridor_phase_spec_v1.md
