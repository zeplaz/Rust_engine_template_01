...
| **Status** | **DONE — SIGNED** |
| **Signed** | 2026-05-24 |
| **Witness** | [`world_preview_d04_slide_sheet_spec_v1.md`](../prompts/guides/ui/world_preview_d04_slide_sheet_spec_v1.md) |
...
| **Brief** | [`ui_phase4_icon_atlas_brief_v1.md`](../prompts/guides/ui/ui_phase4_icon_atlas_brief_v1.md) |
...
Read: prompts/guides/ui/ui_phase4_icon_atlas_brief_v1.md §4–§7
Bake: python tools/orchestrator/scripts/bake_icon_atlas_phase4.py
Test: cargo test -p proc_A_dine01 --lib icon_atlas
Sign: src/dev/ui_oh_p4_art_signoff_record_v1.md §11 SIGNED — PASS
```
...
| **Checklist** | [`ui_phase2_designer_signoff_v1.md`](../prompts/guides/ui/ui_phase2_designer_signoff_v1.md) v2.2.0 |
...
Read: prompts/guides/ui/ui_phase0_panel_mocks_v1.md
      prompts/guides/ui/ui_phase2_designer_signoff_v1.md
      src/dev/ui_oh_d2_signoff_record_v1.md
...
| **Status** | **DONE — SIGNED** |
| **Signed** | 2026-05-24 |
| **Witness** | [`ui_phase2_designer_signoff_v1.md`](../prompts/guides/ui/ui_phase2_designer_signoff_v1.md) **v2.2.0** |
...
| **Signed** | 2026-05-25 |
| **Brief (full prompts)** | [`vfx_post_implementation_review_v1.md`](../prompts/guides/ui/vfx_post_implementation_review_v1.md) |
...
Read: prompts/guides/ui/vfx_post_implementation_review_v1.md
      src/dev/vfx_design_review_record_v1.md
      src/dev/water_vfx_review_record_v1.md
...
| **Status** | **DONE — SIGNED — PASS** |
| **Signed** | 2026-05-25 |
| **Brief (full prompts)** | [`world_preview_d_wp_post_impl_review_v1.md`](../prompts/guides/ui/world_preview_d_wp_post_impl_review_v1.md) |
| **Witness record** | [`world_preview_d_wp_review_record_v1.md`](world_preview_d_wp_review_record_v1.md) |
| **Track rollup** | [`world_preview_d_wp_track_signoff_v1.md`](../prompts/guides/ui/world_preview_d_wp_track_signoff_v1.md) v1.1 |
...
Read: prompts/guides/ui/world_preview_d_wp_post_impl_review_v1.md
      src/dev/world_preview_d_wp_review_record_v1.md
...
Deliverable: src/dev/bq128_editor_path_design_note_v1.md
...
| **Status** | **DONE — SIGNED** |
| **Signed** | 2026-05-25 |
| **Worksheet** | [`stage7_behavioral_decision_worksheet_v1.md`](../prompts/guides/stage7_behavioral_decision_worksheet_v1.md) |
| **Sign-off** | [`stage7_behavioral_d_signoff_v1.md`](stage7_behavioral_d_signoff_v1.md) |
| **Brief** | [`stage7_behavioral_world_designer_brief_v1.md`](../prompts/guides/stage7_behavioral_world_designer_brief_v1.md) |
...
Read: src/dev/stage7_behavioral_full_plan_v1.md
      prompts/guides/stage7_behavioral_decision_worksheet_v1.md (SIGNED picks)
      src/dev/stages/stage7_behavioral_planner_handoff_v1.md
