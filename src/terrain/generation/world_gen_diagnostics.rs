...
pub fn write_world_gen_debug_report(
    ...
    width: u32,
    height: u32,
    map_scale: &crate::terrain::WorldMapScale,
    ...
    let report = WorldGenDebugReport {
        ...
        river_count,
        lake_count,
        meters_per_tile: map_scale.meters_per_tile,
        extent_km_w: map_scale.extent_km(width),
        extent_km_h: map_scale.extent_km(height),
        area_km2: map_scale.area_km2(width, height),
