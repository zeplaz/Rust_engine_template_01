# Elemental spark reference stills

**Status:** **SIGNED** 2026-05-24 · unblocks **FX-FIRE-SPARK-001**

| File | Purpose |
|:---|:---|
| [`fire_spark_target_v1.png`](fire_spark_target_v1.png) | **Before/after** — soft blob (left) vs pinpoint sparks (right) |
| [`legacy_frag_still_01.png`](legacy_frag_still_01.png) | Target read from `frag_partical_BASE_A.glsl` |
...
**Coder:** Phase A → `assets/shaders/fire/fire_particle_draw.wgsl` + `fire_particle.wgsl` only — **no second fire extract**.
