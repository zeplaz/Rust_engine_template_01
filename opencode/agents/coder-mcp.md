...
- [tile-generation](../../.cursor/skills/tile-generation/SKILL.md) — when implementing tile lane
- [validation-first](../../.cursor/skills/validation-first/SKILL.md) — **always for test/build/MCP verify**
