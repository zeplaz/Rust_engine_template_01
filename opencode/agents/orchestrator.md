...
**Skills:** attach [`.cursor/skills/agent-lang/SKILL.md`](../../.cursor/skills/agent-lang/SKILL.md) **every session** — if empty/stale run [sync-claude-skills](../../.cursor/skills/sync-claude-skills/SKILL.md) first.
