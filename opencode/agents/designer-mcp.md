...
| Skill | Purpose |
|-------|---------|
| [mcp-production-rules](../../.cursor/skills/mcp-production-rules/SKILL.md) | Hard constraints — block violations |
| [mcp-asset-pipeline](../../.cursor/skills/mcp-asset-pipeline/SKILL.md) | Orchestration, shipped vs planned |
| [blender-geometry](../../.cursor/skills/blender-geometry/SKILL.md) | Geometry jobs, bpy ops |
| [tile-generation](../../.cursor/skills/tile-generation/SKILL.md) | Tile state machines, atlas |
