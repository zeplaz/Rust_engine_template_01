...
6. **Pathfinding**: must use **same graph** at all tiers with **relaxed refinement** — see `docs/reference/designer_questions/navigation/pathfinding_hierarchical_v1.md`.
...
- Pathfinding LOD handoff: `docs/reference/designer_questions/navigation/pathfinding_hierarchical_v1.md`
