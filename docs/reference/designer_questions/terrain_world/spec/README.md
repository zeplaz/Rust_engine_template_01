...
**Matrix:** `docs/archive/2026-06-prompts-guides/matrix/matrix/terrain_biome/terrain_biome_migration_matrix_v1.md` · **Preview integration:** `docs/archive/2026-06-prompts-guides/matrix/matrix/terrain_biome/composite_style_preview_integration_matrix_v1.md` · **Material unification:** `docs/archive/2026-06-prompts-guides/matrix/matrix/terrain_biome/material_unification_matrix_v1.md`
