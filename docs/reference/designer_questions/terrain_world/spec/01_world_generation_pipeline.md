...
- **Layered fields + preview** (scalar stack, chunk determinism, pixel preview vs sim): [`../composite_style_worldgen_v1.md`](../composite_style_worldgen_v1.md) · matrix: `docs/archive/2026-06-prompts-guides/matrix/matrix/terrain_biome/composite_style_preview_integration_matrix_v1.md`.
- **Material / tag / rule chain** (registry JSON, RON rules, `MaterialId` runtime): [`../material_tag_rule_system_v1.md`](../material_tag_rule_system_v1.md) · matrix: `docs/archive/2026-06-prompts-guides/matrix/matrix/terrain_biome/material_unification_matrix_v1.md`.
