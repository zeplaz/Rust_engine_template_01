...
**Paired design narrative:** [`../material_tag_rule_system_v1.md`](../material_tag_rule_system_v1.md) · **matrix:** `docs/archive/2026-06-prompts-guides/matrix/matrix/terrain_biome/material_unification_matrix_v1.md`
