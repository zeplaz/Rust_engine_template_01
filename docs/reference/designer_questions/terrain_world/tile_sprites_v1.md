...
See also: `docs/archive/2026-06-prompts-guides/matrix/matrix/assets/bevy_asset_config_migration_matrix_v1.md`.
...
- When adding a second format, add a row to `docs/archive/2026-06-prompts-guides/matrix/matrix/assets/bevy_asset_config_migration_matrix_v1.md` (import path + fallback to PNG in dev).
