...
**Matrix:** `docs/archive/2026-06-prompts-guides/matrix/matrix/production/production_migration_matrix_v1.md`, `prompts/matrix/serialization/`, `prompts/matrix/assets/`
