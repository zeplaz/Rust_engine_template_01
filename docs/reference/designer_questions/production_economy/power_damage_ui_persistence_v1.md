...
1. Chart backend → see **In-game analytics vs tooling** + `docs/reference/designer_questions/tools_ui/debug_perf_ui_split_v1.md`.
...
Detail & branching Q’s: `docs/reference/designer_questions/tools_ui/debug_perf_ui_split_v1.md`.
...
- Faction editor: `docs/reference/designer_questions/factions/faction_editor_tooling_matrix_v1.md`.
