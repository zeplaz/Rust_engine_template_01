...
**Pair with:** [`spec/README.md`](spec/README.md), `pathfinding_hierarchical_v1.md`, `docs/reference/designer_questions/terrain_world/chunks_streaming_v1.md` (chunk boundaries).
