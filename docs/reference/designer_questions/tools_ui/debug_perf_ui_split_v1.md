...
- Repair / production UI data: `docs/reference/designer_questions/production_economy/power_damage_ui_persistence_v1.md`
- Chunks / load shedding: `docs/reference/designer_questions/terrain_world/chunks_streaming_v1.md`
- Strategic sim design: `docs/reference/designer_questions/strategic_platforms/README.md`
