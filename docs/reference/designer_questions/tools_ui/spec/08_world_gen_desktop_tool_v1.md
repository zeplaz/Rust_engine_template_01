...
| Pipeline narrative | `docs/reference/designer_questions/terrain_world/spec/01_world_generation_pipeline.md` |
| Layered fields + pixel preview (designer topic) | `docs/reference/designer_questions/terrain_world/composite_style_worldgen_v1.md` |
| Preview / tuning integration matrix | `docs/archive/2026-06-prompts-guides/matrix/matrix/terrain_biome/composite_style_preview_integration_matrix_v1.md` |
| Material / tag / rule system (designer) | `docs/reference/designer_questions/terrain_world/material_tag_rule_system_v1.md` |
| Material unification matrix | `docs/archive/2026-06-prompts-guides/matrix/matrix/terrain_biome/material_unification_matrix_v1.md` |
