...
- `docs/reference/designer_questions/strategic_platforms/platforms_ew_munitions_v1.md` — what to inspect  
- `docs/archive/2026-06-prompts-guides/matrix/matrix/repo/repo_boundary_matrix_v1.md` — never mutate Serializable from UI thread without apply system
