...
**Paired matrices (no single `matrix/factions/` folder):** `docs/archive/2026-06-prompts-guides/matrix/matrix/repo/repo_boundary_matrix_v1.md` (layers) + `docs/archive/2026-06-prompts-guides/matrix/matrix/serialization/serialization_hybrid_migration_matrix_v1.md` + `docs/archive/2026-06-prompts-guides/matrix/matrix/assets/bevy_asset_config_migration_matrix_v1.md`.

---

## Purpose

Rework **faction design** from a single bullet into an **implementable tree**: each row becomes a ticket / milestone with clear **Serializable / ECS / ToolsUI** ownership (see `docs/archive/2026-06-prompts-guides/matrix/matrix/repo/repo_boundary_matrix_v1.md`).

---

## Canonical folder layout (`faction_editor/`)

Index + read order: `docs/reference/designer_questions/factions/faction_editor/README.md`.
...
| FE-04 | Scenario embed vs procedural rules | ✅ | — | wizard | `docs/archive/2026-06-prompts-guides/matrix/matrix/serialization/serialization_hybrid_migration_matrix_v1.md` |
...
| FE-06 | Export/import `.ron` | ✅ | — | file dialog | `docs/archive/2026-06-prompts-guides/matrix/matrix/assets/bevy_asset_config_migration_matrix_v1.md` |
...
- Stance / treaty **data + systems** (to add): keep Serializable vs ECS split per `docs/archive/2026-06-prompts-guides/matrix/matrix/repo/repo_boundary_matrix_v1.md`
- Persistence direction: `docs/archive/2026-06-prompts-guides/matrix/matrix/serialization/serialization_hybrid_migration_matrix_v1.md`
- Parent design: `docs/reference/designer_questions/production_economy/power_damage_ui_persistence_v1.md` (factions §)
- Implementation checklist: `docs/reference/designer_questions/factions/implementation_questions_v1.md`
- **Editor specs (01–05):** `docs/reference/designer_questions/factions/faction_editor/README.md`
