...
- **Export/import** for modding (format: RON per `docs/archive/2026-06-prompts-guides/matrix/matrix/assets/bevy_asset_config_migration_matrix_v1.md` or project convention).
