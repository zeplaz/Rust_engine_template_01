...
**Layers:** Serializable DTOs first; ECS mirrors only where sim needs queries (see `docs/archive/2026-06-prompts-guides/matrix/matrix/repo/repo_boundary_matrix_v1.md`).
