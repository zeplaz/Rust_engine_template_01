...
- **Dev-only** vs **in-game admin:** reuse patterns from `docs/reference/designer_questions/tools_ui/debug_perf_ui_split_v1.md` if applicable; otherwise document one gate resource.
