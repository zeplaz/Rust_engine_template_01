...
| Artifact | Path |
|:---|:---|
| Program plan | `docs/archive/2026-06-src-dev/plans/plan_procedural_building_tiles_production_v1.md` |
| Witness spec | `docs/archive/2026-06-src-dev/plans/procedural_tiles_production_witness_v1.md` |
| Fleet orders | `docs/archive/2026-06-src-dev/plans/mcp_fleet_procedural_tiles_production_orders_v1.md` |
