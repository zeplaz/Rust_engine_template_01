...
| **Active orders (2026-06-03)** | [**`pilot_grammar_agent_orders_v1.md`**](pilot_grammar_agent_orders_v1.md) — paste prompts + critical path 1–5 |

> **Use `pilot_grammar_agent_orders_v1.md` for current @coder-mcp / @designer-mcp sessions.** This file retains generic drain rules + historical planner/coder/designer prompts.
...
Read first: docs/archive/2026-06-src-dev/plans/plan_building_grammar_evolution_v1.md, docs/archive/2026-06-src-dev/plans/arch_build_grammar_001_schema_v1.md, tools/mcp/schemas/assembly_graph_node_v1.schema.json.
...
Read first: docs/archive/2026-06-src-dev/plans/plan_building_grammar_evolution_v1.md, utils/TILE_ISO_RIG_README.md, assets/configs/buildings/style_packs/style_industrial_west.ron.

Exit: docs/archive/2026-06-src-dev/plans/pg_module_audit_warehouse_v1.md (or signoff yaml) + queue DESIGN-* rows + HANDOFF.md.
```
...
## @coder-mcp / @designer-mcp (current — use pilot orders)

**Authoritative paste prompts:** [`pilot_grammar_agent_orders_v1.md`](pilot_grammar_agent_orders_v1.md)

**Critical path:**

```text
1. PILOT-GRAMMAR-E2E-001     done
2. APS-MAT-STUDIO-PHASE-A    @coder-mcp ready
3. BUILD-WORKER-001          @coder-mcp in_progress (verify manual keyframe path)
4. MCP-PILOT-GRAMMAR-001     @designer-mcp blocked
5. Phase 7 register          @coder-mcp → @coder after proceed_ship: yes
```

**Parallel:** `PG-MODULE-AUDIT-002` (@coder-mcp) for P0 `assembly_p0` green.
