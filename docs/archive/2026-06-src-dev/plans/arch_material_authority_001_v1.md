...
| **Source** | [`docs/archive/2026-06-fleet-drain/prompts_drafts/planner_fix_auto_build.md`](../../docs/archive/2026-06-fleet-drain/prompts_drafts/planner_fix_auto_build.md) **L1315–L1700** |
| **Status** | **ACTIVE** — hard rule: [`arch_mat_001_material_authority_v1.md`](arch_mat_001_material_authority_v1.md) (**ARCH-MAT-001**) |
| **Three tracks** | [`plan_three_track_execution_v1.md`](plan_three_track_execution_v1.md) |
| **Date** | 2026-06-03 |
...
**Warehouse** continues as Track B spine test; **production sign-off** blocked until ARCH-MAT-001 is enforced in APS + workers ([`plan_three_track_execution_v1.md`](plan_three_track_execution_v1.md)).
