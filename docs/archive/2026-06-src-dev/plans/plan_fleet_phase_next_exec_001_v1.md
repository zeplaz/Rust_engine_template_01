...
| 7 | **P1-5** P4 | `src/render/perf_attribution_witness.rs`, `docs/archive/2026-06-src-dev/plans/plan_visual_perf_production_exec_001_v1.md` §Baseline | operator re-run + lib | perf block green vs targets | DoD §9 perf exec |
