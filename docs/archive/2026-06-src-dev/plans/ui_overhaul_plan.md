...
**World Preview** (**D-WP**): [`world_preview_d_wp_track_signoff_v1.md`](../docs/archive/2026-06-prompts-guides/ui_phases/guides/ui/world_preview_d_wp_track_signoff_v1.md) · **DESIGN-D-WP-REVIEW-001 PASS** ([`world_preview_d_wp_review_record_v1.md`](world_preview_d_wp_review_record_v1.md)) · D-01 + D-04 + D-07 **done** · D-02 optional.
...
|:---|:---|:---|
| **Phase 1** | **CLOSED** | Layout mocks + theme — [`ui_phase0_panel_mocks_v1.md`](../docs/archive/2026-06-prompts-guides/ui_phases/guides/ui/ui_phase0_panel_mocks_v1.md) |
...
| **Phase 2 sign-off** | **SIGNED** | [`ui_phase2_designer_signoff_v1.md`](../docs/archive/2026-06-prompts-guides/ui_phases/guides/ui/ui_phase2_designer_signoff_v1.md) v2.2.0 · **UI-OH-D2-SIGN-001** [`ui_oh_d2_signoff_record_v1.md`](ui_oh_d2_signoff_record_v1.md) |
...
| **Phase 5** | **PARTIAL (qualified PASS)** | P5-PAUSE-001 **CLOSED** — [`ui_oh_p5_001_plan_v1.md`](ui_oh_p5_001_plan_v1.md) · [`ui_phase5_pause_menu_plan_v1.md`](../docs/archive/2026-06-prompts-guides/ui_phases/guides/ui/ui_phase5_pause_menu_plan_v1.md) |

**Witness profile:** `debug_runs/ui_shell_migration_live.json` → `UI_SHELL_MIGRATION_2B`

**2B gate plan:** [`ui_phase2b_egui_gate_plan_v1.md`](../docs/archive/2026-06-prompts-guides/ui_phases/guides/ui/ui_phase2b_egui_gate_plan_v1.md) (**PLAN-UI-SHELL-2B-001**)
...
| **UI-P3-M3-001** | `@coder` | **done** | **M2** construction + ecology (`ui_p3_m3_green`) — not design M3; see [`ui_phase3_minimap_track_naming_v1.md`](../docs/archive/2026-06-prompts-guides/ui_phases/guides/ui/ui_phase3_minimap_track_naming_v1.md) |
...
| [`ui_phase3_coder_queue_v1.md`](../docs/archive/2026-06-prompts-guides/ui_phases/guides/ui/ui_phase3_coder_queue_v1.md) | **Active:** §3.4 M2 logistics |
...
| [`docs/archive/2026-06-prompts-guides/ui_phases/guides/ui/README.md`](../docs/archive/2026-06-prompts-guides/ui_phases/guides/ui/README.md) | UI guides index |
| [`ui_phase2_sprint_queue.md`](ui_phase2_sprint_queue.md) | Phase 2 archive |
| [`ui_phase3_coder_queue_v1.md`](../docs/archive/2026-06-prompts-guides/ui_phases/guides/ui/ui_phase3_coder_queue_v1.md) | Phase 3 active queue |
