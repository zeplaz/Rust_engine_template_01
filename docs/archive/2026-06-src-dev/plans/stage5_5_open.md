...
| **5.5-D Wave S (product)** | Blueprint / shell RON round-trip; BQ-128/130/133 | [`backlog_serialization_preview_streaming_runbook_v1.md`](../../docs/archive/2026-06-prompts-guides/runbooks/guides/backlog_serialization_preview_streaming_runbook_v1.md), designer briefs | Editor + fixture JSON |
