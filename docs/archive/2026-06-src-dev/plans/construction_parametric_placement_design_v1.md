...
**Theme:** post-industrial archive ([`design_theme.md`](../docs/archive/2026-06-prompts-guides/ui_phases/guides/ui/design_theme.md)) — flat v2 chrome, drafting-ink magenta accent, material badges (stamped valid / overprint invalid).
