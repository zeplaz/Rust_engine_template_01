...
**Operator runbook (step-by-step):** [`pilot_grammar_operator_runbook_v1.md`](pilot_grammar_operator_runbook_v1.md)  
**After Blender:** `powershell -File tools/mcp/scripts/operator_warehouse_keyframe_finish.ps1`
