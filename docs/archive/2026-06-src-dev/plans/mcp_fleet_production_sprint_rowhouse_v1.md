...
```
Sprint MCP-PROD-SPRINT-ROWHOUSE-001 — Week 1 from docs/archive/2026-06-src-dev/plans/mcp_fleet_production_sprint_rowhouse_v1.md.
...
```
Sprint MCP-PROD-SPRINT-ROWHOUSE-001 — Track 1 from docs/archive/2026-06-src-dev/plans/mcp_fleet_production_sprint_rowhouse_v1.md.
...
```
Sprint MCP-PROD-SPRINT-ROWHOUSE-001 — Track 2 from docs/archive/2026-06-src-dev/plans/mcp_fleet_production_sprint_rowhouse_v1.md.
...
```
Sprint MCP-PROD-SPRINT-ROWHOUSE-001 — designer on-call from docs/archive/2026-06-src-dev/plans/mcp_fleet_production_sprint_rowhouse_v1.md.
...
```
Sprint MCP-PROD-SPRINT-ROWHOUSE-001 — engine from docs/archive/2026-06-src-dev/plans/mcp_fleet_production_sprint_rowhouse_v1.md.
