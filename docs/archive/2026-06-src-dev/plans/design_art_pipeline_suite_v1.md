...
Suite + MCP edit layers 1–3; headless Blender compiles layers 4–5. See [`docs/archive/2026-06-fleet-drain/prompts_drafts/planner_fix_auto_build.md`](../../docs/archive/2026-06-fleet-drain/prompts_drafts/planner_fix_auto_build.md) (post–line 400). Manual Blender = debug only ([`warehouse_tile_ship_workflow_v1.md`](warehouse_tile_ship_workflow_v1.md)).
