...
| **Owner** | `@designer` |
| **Status** | **SIGNED** |
| **Parent** | [`minimap_m3_operational_overlay_spec_v1.md`](../docs/archive/2026-06-prompts-guides/ui_phases/guides/ui/minimap_m3_operational_overlay_spec_v1.md) § M3-03 |
...
Read: docs/archive/2026-06-src-dev/plans/minimap_unit_marker_visual_spec_v1.md
