...
**Deliver:** [`docs/archive/2026-06-src-dev/plans/stage7_play_scenario_v1.md`](stage7_play_scenario_v1.md) (create on sign-off) with:
...
**Reference:** [`ui_construction_playtest_v1.md`](../ui_construction_playtest_v1.md), [`concrete_industry_sim_runbook_v1.md`](../../docs/archive/2026-06-prompts-guides/runbooks/guides/concrete_industry_sim_runbook_v1.md)
...
Read [`power_damage_ui_persistence_v1.md`](../../docs/reference/designer_questions/production_economy/power_damage_ui_persistence_v1.md) — one paragraph: what player sees when smelter overloads (toast vs tray vs diagnostics). No Rust.
...
Read: docs/archive/2026-06-src-dev/trees/stages/stage7_play_plan_v1.md
...
Read: docs/archive/2026-06-src-dev/plans/construction_recovery_todos.md (P9 rows)
