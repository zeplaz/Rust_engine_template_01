...
| Item | Owner | Notes |
|:---|:---|:---|
| Replace placeholder atlas with traced silhouettes | `@designer` | ✅ **UI-OH-P4-ART-001** — [`ui_oh_p4_art_signoff_record_v1.md`](../../../docs/archive/2026-06-src-dev/plans/ui_oh_p4_art_signoff_record_v1.md) |
...
- **Minimap movable:** DQ-POST-06 — drag egui Minimap title bar; layout persists via `HudLayoutStore`. See [`ui_construction_playtest_v1.md`](../../../docs/archive/2026-06-src-dev/plans/ui_construction_playtest_v1.md) §1.
