...
Read: docs/archive/2026-06-prompts-guides/ui_phases/guides/ui/world_map_preview_layout_decision_v1.md (§5 choices + §11)
...
Runbook: docs/archive/2026-06-prompts-guides/runbooks/guides/world_preview_runbook_v1.md (pipeline only)
```
...
| [`minimap_d_m1_signoff_v1.md`](../../../docs/archive/2026-06-src-dev/plans/minimap_d_m1_signoff_v1.md) | **D-MINIMAP-M1** — GPU minimap foundation |
| [`minimap_d_m2_signoff_v1.md`](../../../docs/archive/2026-06-src-dev/plans/minimap_d_m2_signoff_v1.md) | **D-MINIMAP-M2** — strategic overlays |
