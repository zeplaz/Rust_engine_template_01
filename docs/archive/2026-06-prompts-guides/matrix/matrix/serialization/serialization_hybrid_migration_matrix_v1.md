...
| Building/vehicle configs | JSON in `assets/configs/` | **RON** (+ migration) | See `docs/archive/2026-06-prompts-guides/matrix/matrix/assets/bevy_asset_config_migration_matrix_v1.md` |
...
3. Per-chunk save files vs monolithic — ties `docs/reference/designer_questions/terrain_world/chunks_streaming_v1.md`
...
- Chunk save policy / queues: `docs/reference/designer_questions/terrain_world/chunks_streaming_v1.md`
