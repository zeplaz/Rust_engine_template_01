...
**Design digest (world layers + corridor model):** [`docs/archive/2026-06-src-dev/plans/world_layer_infrastructure_model_v1.md`](../../../docs/archive/2026-06-src-dev/plans/world_layer_infrastructure_model_v1.md) — tiles = terrain only; transport/utilities = graph networks.
