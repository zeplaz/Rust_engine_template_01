...
| **Touch** | `docs/archive/2026-06-prompts-guides/runbooks/guides/chunk_scheduler_runbook_v1.md` — add short bullet under §4 with file paths (or cross-link to this step). |
