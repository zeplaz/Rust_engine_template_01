...
| **TagId(u16) + TagRegistry + TagSet** | `TagId`, `TagSet`, `TagRegistry`, `TagRegistryLoader` | [`src/terrain/material/tags.rs`](../../../src/terrain/material/tags.rs) | **Applied** — `*.tag_registry.{json,ron}` loader + startup embed |
