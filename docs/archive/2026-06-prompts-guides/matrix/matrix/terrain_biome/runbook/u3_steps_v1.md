...
- New file `src/terrain/material/mod.rs` containing only `// material/tag/rule unification — see docs/archive/2026-06-prompts-guides/runbooks/guides/terrain_unification_runbook_v1.md` and `pub mod registry;` placeholders gated behind `#[allow(unused)]` until U3-S03 lands the file.
...
**Touch:**
- [`docs/archive/2026-06-prompts-guides/matrix/matrix/terrain_biome/material_unification_matrix_v1.md`](../material_unification_matrix_v1.md) — §10 row **U3** → **Applied**.
- [`docs/archive/2026-06-prompts-guides/runbooks/guides/terrain_unification_runbook_v1.md`](../../../guides/terrain_unification_runbook_v1.md) — §4 phase index **U3** → **Applied**.
