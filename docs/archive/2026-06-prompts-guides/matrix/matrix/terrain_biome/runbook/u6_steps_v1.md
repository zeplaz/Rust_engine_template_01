...
**Touch:**
- [`docs/archive/2026-06-prompts-guides/matrix/matrix/terrain_biome/material_unification_matrix_v1.md`](../material_unification_matrix_v1.md) — §10 row **U6** → **Partial** (note: feature-gated terrain layer only).
- [`docs/archive/2026-06-prompts-guides/runbooks/guides/terrain_unification_runbook_v1.md`](../../../guides/terrain_unification_runbook_v1.md) §4 phase index **U6** → **Partial**.
