...
>
> **Prompt use:** Pair with target subsystem’s `designer_questions/…` and its matrix · `rg`/read before moving types across Serializable/ECS/ToolsUI · cite paths · `ASK:` if layer ambiguous. **Navigation / factions** have no dedicated matrix folder — see `docs/archive/2026-06-prompts-guides/matrix/matrix/README.md` § *without a dedicated folder*.
...
- Bevy upgrade: ⏳ **`Cargo.toml` targets `bevy = "0.18"`** — finish Phase D–H in `docs/archive/2026-06-prompts-guides/matrix/matrix/engine_bevy/bevy_0_18_migration_plan.md` (`cargo check` clean = done).
...
- **`prompts/` index** — ✅ see `prompts/README.md` + `prompts/INDEX.md`. Matrix docs live under `prompts/matrix/`:
  ...
  2) `docs/archive/2026-06-prompts-guides/matrix/matrix/terrain_biome/terrain_biome_migration_matrix_v1.md`
  3) `docs/archive/2026-06-prompts-guides/matrix/matrix/production/production_migration_matrix_v1.md`
  4) `docs/archive/2026-06-prompts-guides/matrix/matrix/repo/repo_boundary_matrix_v1.md`
...
1. Read `docs/archive/2026-06-prompts-guides/matrix/matrix/repo/repo_boundary_matrix_v1.md`.
