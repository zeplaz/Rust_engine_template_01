...
2. [`docs/archive/2026-06-prompts-guides/matrix/matrix/terrain_biome/material_unification_matrix_v1.md`](../matrix/terrain_biome/material_unification_matrix_v1.md) §§1, 3, 10 (concept↔symbol, pipeline, U-phase status).
3. [`docs/reference/designer_questions/terrain_world/material_tag_rule_system_v1.md`](../designer_questions/terrain_world/material_tag_rule_system_v1.md) (designer narrative).
...
| **Preview / composite UI** | [`world_preview_runbook_v1.md`](world_preview_runbook_v1.md) | [`../matrix/terrain_biome/composite_style_preview_integration_matrix_v1.md`](../matrix/terrain_biome/composite_style_preview_integration_matrix_v1.md) | Same release train as **U5** (`world_preview`, layer-style preview); chunk-dirty + compositing stages in runbook §3; **binary parity:** [`world_assets_tools_rulebook_v1.md`](world_assets_tools_rulebook_v1.md) |
