...
> Read [`docs/archive/2026-06-prompts-guides/runbooks/guides/backlog_serialization_preview_streaming_runbook_v1.md`](backlog_serialization_preview_streaming_runbook_v1.md) §§1-7. Execute wave **S** before **P**, and **P** before **C**. Do not invent save schema, preview mutation authority, or chunk-streaming thresholds; add or update **BQ-###** in the backlog brief §4 for any unresolved choice.
