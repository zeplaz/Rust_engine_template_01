...
2. [`../../docs/archive/2026-06-src-dev/plans/visual_aidv2.md`](../../docs/archive/2026-06-src-dev/plans/visual_aidv2.md).
...
| Doc | Role |
|:---|:---|
| [`visual_aidv2.md`](../../docs/archive/2026-06-src-dev/plans/visual_aidv2.md) | Product design |
...
> Read [`visual_aidv2_runbook_v1.md`](visual_aidv2_runbook_v1.md) §§1–2 and [`visual_aidv2.md`](../../docs/archive/2026-06-src-dev/plans/visual_aidv2.md). Run one step from [`../matrix/experience/runbook/`](../matrix/experience/runbook/README.md). Verify with `cargo test -p proc_A_dine01 --lib` + autonomous cycle §5. Do not duplicate LOD/fire extract. Halt on §6.
