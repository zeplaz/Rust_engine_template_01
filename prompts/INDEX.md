# Prompts — token-light index

→ **Full tree:** [`README.md`](README.md) · **Routing:** matrix → designer `README` → optional `spec/` → `implementation_questions_v1.md` · **Modes (design vs code):** [`llm_agent_brief.md`](llm_agent_brief.md) § **Workflow — design Q&A vs implementation**.

| Area | Path |
|:---|:---|
| LLM rules | [`llm_agent_brief.md`](llm_agent_brief.md) |
| **Implementation plan** | [`implementation_plan_v1.md`](implementation_plan_v1.md) |
| Matrix (nested) | [`matrix/README.md`](matrix/README.md) |
