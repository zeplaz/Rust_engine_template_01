...
Use this table; `@coder` picks slice from [`vfx_coder_phase2_queue_v1.md`](../../../src/dev/vfx_coder_phase2_queue_v1.md).
...
**Latest record (D-VFX):** [`src/dev/vfx_design_review_record_v1.md`](../../../src/dev/vfx_design_review_record_v1.md) — fire + water summary

**Water-only (FX-WATER track):** [`src/dev/water_vfx_review_record_v1.md`](../../../src/dev/water_vfx_review_record_v1.md) — **WATER-DESIGN-001** SIGNED TUNE (2026-05-24)
