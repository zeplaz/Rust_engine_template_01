...
| **Status** | **M1+M2 SIGNED** — [`minimap_d_m1_signoff_v1.md`](../../../src/dev/minimap_d_m1_signoff_v1.md) · [`minimap_d_m2_signoff_v1.md`](../../../src/dev/minimap_d_m2_signoff_v1.md) |
...
| Design north star | [`src/dev/ux_gpu_minimap_design_v1.md`](../../../src/dev/ux_gpu_minimap_design_v1.md) |
...
~~`resolve_minimap_texture_source` aliased minimap to `WorldPreviewRenderTargetRegistry`.~~ M1 uses dedicated [`MinimapRenderTargetRegistry`](../../../src/render/minimap_compositor/render_target.rs). See [`ux_gpu_minimap_m1_architecture_v1.md`](../../../src/dev/ux_gpu_minimap_m1_architecture_v1.md) for short reference.
...
**M2 defer:** `LogisticsVisualSnapshot`, `EcologyVisualSnapshot`, construction GPU channel — design in [`ux_gpu_minimap_design_v1.md`](../../../src/dev/ux_gpu_minimap_design_v1.md) §4, out of M1 scope.
