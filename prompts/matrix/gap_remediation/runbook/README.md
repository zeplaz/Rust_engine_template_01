...
2. Open the **single** step pack for the active phase. **G1 is Applied** — use it for audits only; active work starts from **G3 GUI** and the backlog wave (see orchestrator §10).
...
| **G3** | [`g3_gui_todos_steps_v1.md`](g3_gui_todos_steps_v1.md) | **Active** GUI TODO index; split by faction editor, production HUD, diagnostics, runtime UI |
...
|:---|:---|:---:|
| [`g3a_faction_editor_steps_v1.md`](g3a_faction_editor_steps_v1.md) | Faction editor | Placeholder until data source / authority recorded |
| [`g3b_production_hud_steps_v1.md`](g3b_production_hud_steps_v1.md) | Production HUD | Placeholder until data source / authority recorded |
| [`g3c_diagnostics_steps_v1.md`](g3c_diagnostics_steps_v1.md) | Diagnostics | Placeholder until data source / authority recorded |
| [`g3d_runtime_ui_steps_v1.md`](g3d_runtime_ui_steps_v1.md) | Runtime in-game UI | Placeholder until data source / authority recorded |

Pair with [`../../../guides/gui_runbook_v1.md`](../../../guides/gui_runbook_v1.md).
